  ...
  const handleBothDisabled = async () => {
    try {
      const result = await openModal<string>(CustomModal, {
        ...
        content:
          "배경 클릭과 ESC 키가 모두 비활성화되었습니다. 반드시 버튼을 눌러야 닫힙니다.",
        disableBackdropClick: true,
        disableEscapeKey: true,
        tone: "danger",
      });
  ...
  const handleSequentialModals = async () => {
    try {
      ...
      if (result1 === "confirm") {
        ...
        // 세 번째 모달 (폼)
        const result3 = await openModal<{ name: string; email: string }>(
          FormModal,
          {
            title: "3단계",
          }
      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <p className="mt-2 text-gray-600">
            다양한 모달 기능을 테스트할 수 있습니다. 각 버튼을 클릭하여
            테스트하세요.
          </p>
        ...
        <section className="bg-white rounded-lg shadow p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <Button
              onClick={handleDisableEscapeKey}
              intent="secondary"
              className="w-full"
            >
              Disable ESC Key
        ...
        <section className="bg-white rounded-lg shadow p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Button
              onClick={handleSequentialModals}
              intent="primary"
              className="w-full"
            >
              순차 모달 (4단계)
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
          ...
          <ul className="space-y-2 text-blue-800 text-sm">
            ...
            <li>
              • ESC 키나 배경 클릭으로 모달을 닫을 수 있습니다 (옵션에 따라
              제한됨).
            </li>
            <li>• 브라우저 콘솔(F12)을 열어 모달의 반환값을 확인하세요.</li>
            <li>• &quot;순차 모달&quot;은 여러 모달을 차례로 표시합니다.</li>
            <li>
              • 모든 모달은 Promise 기반으로 동작하여 async/await로 결과를
              받습니다.
            </li>
          </ul>
        </div>
